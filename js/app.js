    ...
    const BathingItems = [
        {
            ...
            description: "<p style='color: red'>«В этот светлый праздник»</p><p>В этот светлый праздник – <br />Праздник Рождества <br />Мы друг другу скажем <br />Теплые слова.</p>" +
            "<p>Тихо снег ложится: <br />За окном зима, <br />Чудо здесь свершится <br />И зажжёт сердца.</p>" +
            "<p>Пусть улыбки ваши <br />В этот дивный день <br />Будут счастьем нашим <br />И подарком всем.</p>" +
            "<p>Льются звуки жизни, <br />Счастья и добра, <br />Озаряя мысли <br />Светом Рождества.</p>" +
            "<p>Автор: Алексей Хомяков</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p style='color: red'>Под напев молитв пасхальных...</p><p>Под напев молитв пасхальных\n" +
            ...
            "С белокрылым мотыльком!</p><p>Автор: К. М. Фофанов <br />1878 г.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
