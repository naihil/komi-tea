...
function fillCatalogItems() {
    ...
    const IvanTeaCatalogItems = [
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>МОРОШКА</span> придаёт напитку сильный приятный аромат и пикантный свежий вкус. Это целебное средство от общего упадка сил, депрессий, при отсутствии аппетита, помогает при сильном кашле. Высокое содержание витаминов А и С делают его средством сохранения молодости.</p>",
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЧЕРНИКА</span> снимает усталость глаз, улучшает зрение, снижает уровень сахара в крови, богата витаминами В1, С и РР. Повышает уровень гемоглобина, очищает печень, регулирует функцию поджелудочной железы, благотворно влияет на желудок.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ГОЛУБИКА</span> нормализует функцию поджелудочной железы, снижает уровень сахара в крови, снимает напряжение с глаз, выводит радиацию из организма, укрепляет стенки сосудов, способствует расщеплению жиров в организме. Улучшает процесс кроветворения и состав крови; тонизирует стенки капилляров; нормализует давление; предупреждает развитие онкологии.</p>" +
            "<p><span class='catalog-text-bold'>ВАСИЛЁК</span> применяется при отёках почечного и сердечного происхождения, при ОРЗ с лихорадкой и головной болью, снимает спазмы гладкой мускулатуры внутренних органов. Полезен при лечении «куриной слепоты» (нарушениях сумеречного зрения).</p>",
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>МАЛИНА</span> дарит напитку изумительный вкус и аромат – сладкий с тонкой кислинкой. Ферментированный лист малины – это кладезь полезных веществ, а также незаменимое средство при простуде, эффективно снимает отеки и воспаления.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>СМОРОДИНА</span> – природный концентрат витаминов, микро- и макроэлементов. Стабилизирует кровяное давление, предупреждает болезнь Альцгеймера. Полезна при проблемах со зрением, сахарном диабете, болезнях почек и верхних дыхательных путей.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>РЯБИНА</span> – это поливитаминное средство при авитаминозе. Предотвращает стрессы, депрессии, раздражительность, бессонницу. Рекомендуется при атеросклерозе. Содержит дубильные вещества, органические кислоты, витамины, эфирные масла, благотворно влияет на деятельность ЖКТ.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>БРУСНИКА</span> повышает защитные силы организма, укрепляет сосуды, обладает мочегонным и антибактериальным эффектом, устраняет отечность. Содержит аскорбиновую кислоту, каротин, соли калия и марганца, дубильные вещества, флавоноиды, кумарины.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЧЕРЁМУХА</span> укрепляет стенки кровеносных сосудов, нормализует нервную деятельность, замедляет процессы старения организма. Обладает вяжущим действием. Очищает организм от шлаков, токсических и канцерогенных веществ.</p>",
        ...
        },
        {
            ...
            description: "<p>Полезные вещества в листьях <span class='catalog-text-bold'>ОЛЬХИ</span> помогают справиться с аллергией, стоматитом, кровоточивостью дёсен, болями в желудке, простудными заболеваниями.</p>" +
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ВИШНЯ</span> придаёт напитку яркий аромат и мягкий древеснопряный вкус. Бодрит и поднимает настроение. Это отличный витаминный напиток, который понижает артериальное давление и облегчает симптомы простуды.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЯБЛОКИ</span> благотворно влияют на нервную систему, иммунитет, работу памяти и интеллектуальные способности, понижают давление и помогают при тромбофлебите.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ИМБИРЬ</span> - натуральный источник витаминов, минералов и всех незаменимых аминокислот. Наполняет свежей энергией, повышает жизненный тонус. Регулирует вес. Укрепляет память, иммунитет, суставы и сердце. Восстанавливает желудок, кишечник, печень. Пряный аромат и чуть терпкий вкус имбиря подарят хорошее самочувствие.</p>",
            contra: "индивидуальная непереносимость, период беременности и лактации"
        },
        {
        ...
        },
        {
            ...
            description: "<p>«Однажды ты встретишь кого-то, кто будет любить тебя так, как Маленький Принц любит свою розу».</p> <p>Роза – символ любви, а <span class='catalog-text-bold'>ИВАН ЧАЙ С ЛЕПЕСТКАМИ САДОВОЙ РОЗЫ</span> – само воплощение нежности, которая достигается благодаря эфирным маслам, которые придают напитку тонкий аромат и приятный вкус. Лепестки розы также обладают вяжущими, бактерицидными, противовоспалительными свойствами.</p>",
            contra: "индивидуальная непереносимость"
        },
        {
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ДУШИЦА</span> расслабляет, успокаивает нервную систему, понижает кровяное давление, обладает тёплым медовым ароматом. Стимулирует секрецию пищеварительных желез и бронхов, благотворно влияет на женское здоровье, улучшает аппетит.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЧАБРЕЦ</span> обладает тонизирующими свойствами, хорошо пить такой чай в сезон простуд и эпидемий гриппа. Снимает усталость, успокаивает нервную систему, уменьшает мышечные и суставные боли, улучшает работу желудка и кишечника.</p>" +
            "<p><span class='catalog-text-bold'>ДУШИЦА</span> помогает справиться с бессонницей, улучшает аппетит, ускоряет обмен веществ, мягко снижает артериальное давление.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЗВЕРОБОЙ</span> издавна народ Коми использовал как тонизирующее и иммуностимулирующее средство для повышения защитных сил организма, нормализации обмена веществ. Не подходит для частого применения.</p>" +
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЭСТРАГОН</span> улучшает образование желудочного сока, нормализует аппетит. Обладает общеукрепляющим и мочегонным действием; нормализует сон, обладает антигельминтным действием.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ТАВОЛГА</span> (лабазник вязолистый) применяется при лечении простуды, язвы желудка, для снятия усталости и нормализации ночного сна. Уменьшает хронические боли и воспаления суставов, улучшает пищеварение.</p>" +
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>Молодые листья берёзы</span> препятствуют солеотложению в суставах. Используют при воспалительных заболеваниях почек и мочевого пузыря. Являются самым доступным и эффективным мочегонным средством, снижая отёки, уменьшая одышку. Улучшают кровообращение, растворяют тромбы. Помогают при простуде, заболевании верхних дыхательных путей. Антигельминтное средство.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
    ];
    ...
    const BathingItems = [
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>КУРИЛЬСКИЙ ЧАЙ</span> используют вместо обычного чая. Применение напитка помогает при расстройствах нервной системы (депрессии, неврозы, нервные истощения), желудочно-кишечных инфекциях, дисбактериозе, сахарном диабете, гинекологических заболеваниях. Снижает, стабилизирует кровяное давление.</p>" +
            "<p><span class='catalog-text-bold'>ЧЕРНИКА</span> снимает усталость глаз, улучшает зрение, снижает уровень сахара в крови, богата витаминами В1, С и РР. Повышает уровень гемоглобина, очищает печень, регулирует функцию поджелудочной железы, благотворно влияет на желудок.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>РАЗНОТРАВИЕ</span> – это лето севера в одной чайной упаковке. Разнотравие – это объединение для иммунитета и ярких дней Иван чая с: листом малины, шиповником, клевером, рябиной, чёрной смородиной, ромашкой, зверобоем, душицей, черёмухой, таволгой, лепестками садовой розы и молодых листьев берёзы (освященных на Троицын день).</p>" +
            "<p><span class='catalog-text-bold'>ЛИСТ МАЛИНЫ</span> незаменимое средство при простуде. <span class='catalog-text-bold'>ШИПОВНИК</span> - кладезь витаминов. <span class='catalog-text-bold'>КЛЕВЕР</span> благотворно влияет на сердечно–сосудистую систему. <span class='catalog-text-bold'>ЛИСТ БЕРЁЗЫ</span> снимает отёки, улучшает кровообращение. <span class='catalog-text-bold'>РЯБИНА</span> предотвращает стрессы. <span class='catalog-text-bold'>СМОРОДИНА</span> стабилизирует давление. <span class='catalog-text-bold'>РОМАШКА</span> расслабляет. <span class='catalog-text-bold'>ДУШИЦА</span> успокаивает нервную систему. <span class='catalog-text-bold'>ЧЕРЁМУХА</span> замедляет процессы старения организма. <span class='catalog-text-bold'>ТАВОЛГА</span> помогает снять усталость. <span class='catalog-text-bold'>ИВАН-ЧАЙ</span> улучшает обмен веществ. <span class='catalog-text-bold'>ЛЕПЕСТКИ РОЗЫ</span> богаты эфирными маслами, которые придают напитку тонкий аромат и приятный вкус.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>МЕЛИССА</span> и <span class='catalog-text-bold'>МЯТА</span> успокаивают, <span class='catalog-text-bold'>РОМАШКА</span> расслабляет, <span class='catalog-text-bold'>ШИПОВНИК</span> наполняет витаминами, <span class='catalog-text-bold'>СМОРОДИНА</span> стабилизирует давление, нормализует работу почек и повышает гемоглобин, <span class='catalog-text-bold'>ЛИПОВЫЙ ЦВЕТ</span> помогает бороться с инфекциями, а также придает дивный аромат. Великолепно укрепляет и оздоравливает весь организм, не вызывая при этом негативных побочных явлений.</p>" +
        ...
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ВИШНЯ</span> – природный антиоксидант с противовоспалительными свойствами, препятствует образованию тромбов, нормализует деятельность сердечно-сосудистой системы, придает тонкий аромат. <span class='catalog-text-bold'>ЧЕРЕМУХА</span> содержит витамины С и Е, эфирные масла, органические кислоты. <span class='catalog-text-bold'>КОРИЦА</span> способствует похудению, снижает уровень холестерина и риск образования тромбов, улучшает мозговую деятельность.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p>Пряный напиток с оригинальным ароматом и пикантным вкусом. <span class='catalog-text-bold'>МЯТА</span> успокаивает. <span class='catalog-text-bold'>ГВОЗДИКА</span> одновременно тонизирует и снимает спазмы, содержит провитамин А (бета-каротин), витамины группы В (В1, В2, В3 или РР, В4, В6, В9), витамин С (аскорбиновая кислота), витамин Е и витамин К, полезные минералы: калий, кальций, натрий, магний, фосфор, железо, марганец, медь, селен, цинк. <span class='catalog-text-bold'>КОРИЦА</span> снижает аппетит. <span class='catalog-text-bold'>ЯБЛОКИ</span> благотворно влияют на нервную систему, иммунитет, работу памяти и интеллектуальные способности, понижают давление и помогают при тромбофлебите.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p>Чай с <span class='catalog-text-bold'>чабрецом, имбирем и лимоном</span> – чай, способный дарить тепло и объединять сердца в холодной период сказки, сказки жизни, и не важно зима это или ветреный летний вечер. Такое сочетание ускоряет метаболизм, тонизирует и стимулирует кровообращение, способствует очищению крови, помогает избавится от токсинов и шлаков. Яркая нота — лимон.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },
        {
            ...
            description: "<p><span class='catalog-text-bold'>ЯБЛОКИ</span> положительно влияют на обменные процессы в организме, улучшают пищеварение, благотворно влияют на нервную систему и работу памяти. <span class='catalog-text-bold'>ИМБИРЬ</span>, натуральный источник витаминов и минералов. Регулирует вес, наполняет энергией, повышает жизненный тонус, укрепляет память. <span class='catalog-text-bold'>КОРИЦА</span> в напитке ускоряет метаболизм, тонизирует.</p>",
            contra: "индивидуальная непереносимость, период беременности, лактации"
        },

    ];

    const template = $("#catalog-item-template").html();
    const catalogRow = $("#catalogIvanTea-row");
    for (let i = 0; i < IvanTeaCatalogItems.length; i++) {
        const v = IvanTeaCatalogItems[i];
        catalogRow.append(nano(template, v));
    }

    const bathingsRow = $("#catalogBathings-row")
    for (let i = 0; i < BathingItems.length; i++) {
        const v = BathingItems[i];
        bathingsRow.append(nano(template, v));
    }
}
